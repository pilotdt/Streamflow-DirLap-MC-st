...
from data.adjacency import calculate_random_walk_matrix, calculate_scaled_laplacian
...
class DCGRUCell(BaseModel):
    ...
    def _gconv(self, inputs, state, output_size, bias_start=0.0):
        ...
        x += biases
        # Reshape res back to 2D: (batch_size, num_node, state_dim) to (batch_size, num_node * state_dim)
