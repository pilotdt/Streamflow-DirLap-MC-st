"""
Example usage: python3 src/main_slstm.py 
Or:    python3 src/main_slstm.py reg_4_loss="L_dir"
Or:    python3 src/main_slstm.py reg_4_loss="L_dir" add_storage=True
"""
import hydra
...
@hydra.main(version_base=None, config_path="../config", config_name="xlstm")
