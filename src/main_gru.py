"""
Example usage: python3 src/main_gru.py lr=0.1 num_runs=1
Or:    python3 src/main_gru.py  reg_4_loss="L_dir"       
Or:    python3 src/main_gru.py  reg_4_loss="L_dir" add_storage=True
"""
