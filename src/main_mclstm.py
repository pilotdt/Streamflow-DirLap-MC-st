"""
Example usage: python3 src/main_mclstm.py 
"""
...
def run_single_experiment(cfg, run_id, train_loader, val_loader, std_per_station, seq_lengths,
    ...
    model = MCLSTM(
        ...
        features_per_station=in_features,       
        horizon=cfg['horizon'],
    ...
    # Evaluate model, l adv, use packing 
    start_inf = time.time()
...
@hydra.main(version_base=None, config_path="../config", config_name="mclstm")
