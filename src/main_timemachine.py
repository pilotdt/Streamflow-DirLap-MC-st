"""
Example usage: python3 src/main_timemachine.py
"""
...
from models.timemachine import TimeMachine
...
@hydra.main(version_base=None, config_path="../config", config_name="timemachine.yaml")
