...
Usage: python3 src/optimise_prms_lstm.py reg_4_loss=""
Or:    python3 src/optimise_prms_lstm.py reg_4_loss="L_dir"
Or:    python3 src/optimise_prms_lstm.py reg_4_loss="L_dir" add_storage=True
"""
...
@hydra.main(version_base=None, config_path="../config", config_name="lstm.yaml")
