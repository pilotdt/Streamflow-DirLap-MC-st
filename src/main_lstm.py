"""
Example usage: python3 src/main_lstm.py num_runs=1
Or:    python3 src/main_lstm.py reg_4_loss="L_dir"       
Or:    python3 src/main_lstm.py reg_4_loss="L_dir" add_storage=True
"""
